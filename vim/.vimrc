...
" nnoremap <Leader>t :botright split <CR>:terminal<CR>
...
" This config will set some basic options and keybindings, and it will also load a colorscheme. You
" can customize this config to your own liking.
"
...
" A basic vimrc config that you can use as a starting point:
...
"set laststatus=2
"set showcmd
"set wildignore+=*.swp,*.bak,*.pyc,*.class,*.min.*
"colorscheme habamax
...
"" Autocommands
"autocmd BufReadPost *.py setlocal autoindent smartindent softtabstop=4 shiftwidth=4 tabstop=4 expandtab
"autocmd BufReadPost *.js setlocal autoindent smartindent softtabstop=4 shiftwidth=4 tabstop=4 expandtab
"autocmd BufReadPost *.html setlocal autoindent smartindent softtabstop=4 shiftwidth=4 tabstop=4 expandtab
